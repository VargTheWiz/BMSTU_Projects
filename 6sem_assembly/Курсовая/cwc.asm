;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
;  комменатрии, начинающиеся с символа @ - места, где код зависит от варианта
;
;  Автор:
;  МГТУ им. Н.Э. Баумана, ИУ5Ц-61Б, 2021 г.
;  Рябкин А.В.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
code segment	'code'
    ...
    replaceWith                     DB  'ФИСВУАПРШОЛДЬТЩЗЙКЫЕГМЦЧНЯфисвуапршолдьтщзйкыегмцчня'
	ignoredLength 				equ	$-ignoredChars				; длина строки ignoredChars
	ignoreEnabled 				DB	0							; флаг функции игнорирования ввода
	translateFrom 				DB	'HCNEA'						;@ символы для замены (ЛМНОП на англ. раскладке)
	...
	charToCursiveIndex 			DB 'Г'							;@ символ для замены
	...
	signatureLine1				DB	179, '            Рябкин Александр           ', 179
	Line1_length 					equ	$-signatureLine1
	signatureLine2				DB	179, '                 ИУ5Ц-61Б                ', 179
	...
	helpMsg DB '>kr.com [/?] [/u]', 10, 13
			...
			DB '  F4  - вывод ФИО и группы по таймеру в центре экрана', 10, 13
			DB '  F5  - включение и отключения курсивного вывода русского символа Г', 10, 13
			DB '  F6  - включение и отключение частичной русификации клавиатуры(HCNEA -> РСТУФ)', 10, 13
			DB '  F7  - включение и отключение режима замены латинских символов на русские', 10, 13
...
new_int1Ch proc far
	...
	cmp signaturePrintingEnabled, true ; если нажата управляющая клавиша (в данном случае F3)
	jne _notToPrint		
